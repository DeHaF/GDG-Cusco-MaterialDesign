...
public class MainActivityFragment extends Fragment {
    ...
    //Abre la actividad Principal, asignando la animacion del tema
    public void lanzarDetalle(View rootView,int NroLibro) {
